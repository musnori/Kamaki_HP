      ...
      <Section title="お問い合わせ" subtitle="製品についてのご質問や、お取引のご相談はこちらから。">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white/50 p-5 rounded-2xl border border-neutral-100">
          ...
          <div className="lg:col-span-2">
            {submitted ? (
              ...
              <form
                ...
                className="bg-white p-5 md:p-6 rounded-2xl border border-neutral-200 shadow-sm space-y-6"
              >
